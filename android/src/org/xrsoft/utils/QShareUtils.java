...
//     private static String AUTHORITY="org.xrsoft.fitapp.sharex.fileprovider";

//     protected QShareUtils()
//     {
//        //Log.d("xrsoft", "QShareUtils()");
//     }
...
//             Log.d("xrsoft checkMime ", "YEP - we can go on and View");
//             return true;
//         } else {
//             Log.d("xrsoft checkMime", "sorry - no App available to View");
//         }
//         return false;
//     }
...
//         // Verify that the intent will resolve to an activity
//         if (myIntent.resolveActivity(QtNative.activity().getPackageManager()) != null) {
//             Log.d("xrsoft checkMime ", "YEP - we can go on and Edit");
//             return true;
//         } else {
//             Log.d("xrsoft checkMime", "sorry - no App available to Edit");
//         }
//         return false;
//     }
...
//             return true;
//         } else {
//             Log.d("xrsoft share", "Intent not resolved");
//         }
//         return false;
//     }
...
//             Log.d("xrsoft", title+" PackageManager cannot resolve Activity");
//             return false;
//         }
...
//             // Log.d("xrsoft", title+" defaultAppInfo not Resolver or EditActivity: "+defaultAppInfo.activityInfo.name);
//             // return false;
//         //}
...
//             Log.d("xrsoft", title+" appInfoList.isEmpty");
//             return false;
//         }
//         Log.d("xrsoft", title+" appInfoList: "+appInfoList.size());
...
//                 Log.d("xrsoft", "legacy support grantUriPermission");
//                 context.grantUriPermission(targetPackageName, uri, Intent.FLAG_GRANT_READ_URI_PERMISSION | Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
...
//             Log.d("xrsoft", title+" targetedIntents.isEmpty");
//             return false;
//         }
...
//         if (targetedIntents.isEmpty()) {
//             Log.d("xrsoft", title+" only one Intent left for Chooser");
//         } else {
...
//             return true;
//         }
//         Log.d("xrsoft", title+" Chooser Intent not resolved. Should never happen");
//         return false;
//     }
...
//             Log.d("xrsoft sendFile - cannot be shared: ", filePath);
//             return false;
//         }

//         Log.d("xrsoft sendFile", uri.toString());
//         sendIntent.putExtra(Intent.EXTRA_STREAM, uri);

//         if(mimeType == null || mimeType.isEmpty()) {
//             // fallback if mimeType not set
//             mimeType = QtNative.activity().getContentResolver().getType(uri);
//             Log.d("xrsoft sendFile guessed mimeType:", mimeType);
//         }  else {
//             Log.d("xrsoft sendFile w mimeType:", mimeType);
//         }
...
//             uri = FileProvider.getUriForFile(QtNative.activity(), AUTHORITY, imageFileToShare);
//         } catch (IllegalArgumentException e) {
//             Log.d("xrsoft viewFile - cannot be shared: ", filePath);
//             return false;
//         }
//         // now we got a content URI per ex
//         // content://org.xrsoft.fitapp.sharex.fileprovider/my_shared_files/qt-logo.png
//         // from a fileUrl:
//         // /data/user/0/org.xrsoft.fitapp.sharex/files/share_example_x_files/qt-logo.png
//         Log.d("xrsoft viewFile from file path: ", filePath);
//         Log.d("xrsoft viewFile to content URI: ", uri.toString());

//         if(mimeType == null || mimeType.isEmpty()) {
//             // fallback if mimeType not set
//             mimeType = QtNative.activity().getContentResolver().getType(uri);
//             Log.d("xrsoft viewFile guessed mimeType:", mimeType);
//         } else {
//             Log.d("xrsoft viewFile w mimeType:", mimeType);
//         }
...
//             uri = FileProvider.getUriForFile(QtNative.activity(), AUTHORITY, imageFileToShare);
//         } catch (IllegalArgumentException e) {
//             Log.d("xrsoft editFile - cannot be shared: ", filePath);
//             return false;
//         }
//         Log.d("xrsoft editFile", uri.toString());

//         if(mimeType == null || mimeType.isEmpty()) {
//             // fallback if mimeType not set
//             mimeType = QtNative.activity().getContentResolver().getType(uri);
//             Log.d("xrsoft editFile guessed mimeType:", mimeType);
//         } else {
//             Log.d("xrsoft editFile w mimeType:", mimeType);
//         }
...
//                         Log.d("xrsoft - create File", filePath);
//                         File f = new File(filePath);
//                         FileOutputStream tmp = new FileOutputStream(f);
//                         Log.d("xrsoft - create File", "new FileOutputStream");
